...
os.system("rm ./inferenceCoreRuntime.csv")
outfile = open('inferenceCoreRuntime.csv', 'a', newline='')
spamwriter = csv.writer(outfile, delimiter=',')
if CPUONLY:
    spamwriter.writerow(['Model', 'Dataset', 'CPU_O (ms)','CPU_P (ms)'])
else:
    spamwriter.writerow(['Model','Dataset','CPU_O (ms)','CPU_P (ms)', 'GPU_O (ms)','GPU_P (ms)'])
