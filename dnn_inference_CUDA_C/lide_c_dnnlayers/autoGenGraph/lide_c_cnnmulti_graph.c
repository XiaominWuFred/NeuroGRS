#include <stdio.h>
#include <stdlib.h>
#include "lide_c_cnnmulti_graph.h"
...
#define INPUTDIMconv1 11
#define INPUTNUMconv1 1
#define PICNconv1 1
#define FILTERNUMconv1 32
#define OUTDIMconv1 10
#define OUTNUMconv1 32
#define MPSTEPmax_pooling2d_1 2
#define OUTDIMMPmax_pooling2d_1 5
#define FILTERNUMmax_pooling2d_1 32
#define FILTERDIMconv2 2
#define INPUTDIMconv2 5
#define INPUTNUMconv2 1
#define PICNconv2 32
#define FILTERNUMconv2 16
#define OUTDIMconv2 4
#define OUTNUMconv2 16
#define NODENUMdense1 32
#define INPUTNUMdense1 1
#define INPUTDIMdense1 114
#define NODENUMdense2 16
#define INPUTNUMdense2 1
#define INPUTDIMdense2 114
#define NODENUMdense3 8
#define INPUTNUMdense3 1
#define INPUTDIMdense3 114
#define NODENUMdense4 2
#define INPUTNUMdense4 1
#define INPUTDIMdense4 114
lide_c_cnnmulti_graph_context_type *lide_c_cnnmulti_graph_new(const char * InputsFile, 
    ...
    const char* OutFile ){
    int token_size;
    lide_c_cnnmulti_graph_context_type * context = NULL;
    context = (lide_c_cnnmulti_graph_context_type *)lide_c_util_malloc(sizeof(
        lide_c_cnnmulti_graph_context_type));
    ...
    context->fifos[FIFO_RELU2max_pooling2d_1] = (lide_c_fifo_pointer)lide_c_fifo_new(BUFFER_CAPACITY, token_size);
    ...
    context->fifos[FIFO_dense22RELU ] = (lide_c_fifo_pointer)lide_c_fifo_new(BUFFER_CAPACITY, token_size);
    context->fifos[FIFO_W2dense3] = (lide_c_fifo_pointer)lide_c_fifo_new(BUFFER_CAPACITY, token_size);
    context->fifos[FIFO_B2dense3] = (lide_c_fifo_pointer)lide_c_fifo_new(BUFFER_CAPACITY, token_size);
    context->fifos[FIFO_RELU2dense3] = (lide_c_fifo_pointer)lide_c_fifo_new(BUFFER_CAPACITY, token_size);
    context->fifos[FIFO_dense32RELU ] = (lide_c_fifo_pointer)lide_c_fifo_new(BUFFER_CAPACITY, token_size);
    context->fifos[FIFO_W2dense4] = (lide_c_fifo_pointer)lide_c_fifo_new(BUFFER_CAPACITY, token_size);
    context->fifos[FIFO_B2dense4] = (lide_c_fifo_pointer)lide_c_fifo_new(BUFFER_CAPACITY, token_size);
    context->fifos[FIFO_RELU2dense4] = (lide_c_fifo_pointer)lide_c_fifo_new(BUFFER_CAPACITY, token_size);
    context->fifos[FIFO_dense42SOFTMAX ] = (lide_c_fifo_pointer)lide_c_fifo_new(BUFFER_CAPACITY, token_size);
    ...
    context->actors[ACTOR_RELUCNN_conv1] = (lide_c_actor_context_type*)(lide_c_reluCnn_new(context->fifos[FIFO_conv12RELU],context->fifos[FIFO_RELU2max_pooling2d_1],INPUTNUMconv1,OUTDIMconv1,FILTERNUMconv1));
    context->actors[ACTOR_MAXPOOL_max_pooling2d_1] = (lide_c_actor_context_type*)(lide_c_maxpool_new(context->fifos[FIFO_RELU2max_pooling2d_1],context->fifos[FIFO_MP2conv2],MPSTEPmax_pooling2d_1, OUTNUMconv1,OUTDIMconv1));
    ...
    context->actors[ACTOR_DENSE_dense2] = (lide_c_actor_context_type*)(lide_c_dense_new(context->fifos[FIFO_RELU2dense2],context->fifos[FIFO_W2dense2],context->fifos[FIFO_B2dense2],context->fifos[FIFO_dense22RELU],INPUTNUMdense2,NODENUMdense1, NODENUMdense2));
    context->actors[ACTOR_RELUDEN_dense2] = (lide_c_actor_context_type*)(lide_c_reluDense_new(context->fifos[FIFO_dense22RELU],context->fifos[FIFO_RELU2dense3],INPUTNUMdense2,NODENUMdense2));
    context->actors[ACTOR_READW_DENSE_dense3] = (lide_c_actor_context_type*)(lide_c_read1D_new(context->fifos[FIFO_W2dense3], Wdense3,NODENUMdense2*NODENUMdense3));
    context->actors[ACTOR_READB_DENSE_dense3] = (lide_c_actor_context_type*)(lide_c_read1D_new(context->fifos[FIFO_B2dense3],Bdense3,NODENUMdense3));
    context->actors[ACTOR_DENSE_dense3] = (lide_c_actor_context_type*)(lide_c_dense_new(context->fifos[FIFO_RELU2dense3],context->fifos[FIFO_W2dense3],context->fifos[FIFO_B2dense3],context->fifos[FIFO_dense32RELU],INPUTNUMdense3,NODENUMdense2, NODENUMdense3));
    context->actors[ACTOR_RELUDEN_dense3] = (lide_c_actor_context_type*)(lide_c_reluDense_new(context->fifos[FIFO_dense32RELU],context->fifos[FIFO_RELU2dense4],INPUTNUMdense3,NODENUMdense3));
    context->actors[ACTOR_READW_DENSE_dense4] = (lide_c_actor_context_type*)(lide_c_read1D_new(context->fifos[FIFO_W2dense4], Wdense4,NODENUMdense3*NODENUMdense4));
    context->actors[ACTOR_READB_DENSE_dense4] = (lide_c_actor_context_type*)(lide_c_read1D_new(context->fifos[FIFO_B2dense4],Bdense4,NODENUMdense4));
    context->actors[ACTOR_DENSE_dense4] = (lide_c_actor_context_type*)(lide_c_dense_new(context->fifos[FIFO_RELU2dense4],context->fifos[FIFO_W2dense4],context->fifos[FIFO_B2dense4],context->fifos[FIFO_dense42SOFTMAX],INPUTNUMdense4,NODENUMdense3, NODENUMdense4));
    context->actors[ACTOR_SOFTMAX] = (lide_c_actor_context_type*)(lide_c_softmax_new(context->fifos[FIFO_dense42SOFTMAX],context->fifos[FIFO_SM2WO],INPUTNUMdense4,NODENUMdense4));
    context->actors[ACTOR_WRITEOUT] = (lide_c_actor_context_type *)(lide_c_writeout_new(OutFile,context->fifos[FIFO_SM2WO],INPUTNUMdense4,NODENUMdense4));
    context->scheduler = (lide_c_graph_scheduler_ftype)
        lide_c_cnnmulti_graph_scheduler;
    return context;
}
void lide_c_cnnmulti_graph_scheduler(lide_c_cnnmulti_graph_context_type *context){
